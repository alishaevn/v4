...
Will there still be an issue when you'd like to include an apostrophe and you don't want to use escape characters? _Not if you wrap the sentence in backtick's instead._ 😏 Which look much more similar to single quotes anyway. So it still passes the eye test in my book.
